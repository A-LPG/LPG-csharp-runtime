...
public class JavaKWLexerprs : LPG2.Runtime.ParseTable, JavaKWLexersym {
    ...
    public const int START_STATE = 95;
    ...
    public   bool isValidForParser() { return JavaKWLexersym.isValidForParser; }
