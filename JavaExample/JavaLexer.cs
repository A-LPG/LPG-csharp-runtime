...
public class JavaLexer : object , RuleAction
{
    ...
    public JavaLexer(string filename, int tab)  
    {
        reset(filename, tab);
    }
   ...
   public  bool printTokens=false;
    ...
    public JavaLexer(string filename) : this(filename, ECLIPSE_TAB_VALUE)
    {
    ...
    public override string[] orderedExportedSymbols() { return JavaParsersym.orderedTerminalSymbols; }

    public JavaLexerLpgLexStream(string filename, int tab) :base(filename, tab)
    {
        
    }

    public JavaLexerLpgLexStream(char[] input_chars, string filename, int tab): base(input_chars, filename, tab)
    {
       
    }

    public JavaLexerLpgLexStream(char[] input_chars, string filename): base(input_chars, filename, 1)
    {
